...
<template>
  <section class="my-5 py-5" id="projects">
    <div class="container">
      <div class="row">
        <div class="row justify-content-center text-center my-sm-5">
          <div class="col-lg-6">
            <h2 class="text-dark mb-0 text-6xl">Side Projects</h2>
            <h3 class="lead pt-lg-4 font text-sm">
              꾸준히 사이드 프로젝트를 진행하며 여러 기술의 사용과 경험을 익히고 있습니다.
            </h3>
          </div>
        </div>
      </div>
    ...
    <div class="container mt-sm-5 mt-3">
      ...
      >
        <div :class="`${col1 ?? 'col-lg-3'}`">
          ...
          >
            <h3>{{ heading }}</h3>
            <h6 class="text-secondary font-weight-normal pe-3 text-sm">
              {{ description }}
            </h6>
          </div>
        </div>
