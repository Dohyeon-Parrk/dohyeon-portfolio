    ...
    >
      ...
      <div class="container">
        <div class="row">
          ...
          >
            <h1 class="text-white mb-4">scm(supply chain management)</h1>
            <p class="text-white opacity-8 lead pe-5 me-5">
              공급망 관리 시스템 관리자 페이지 구현<br />
              Vuejs 프론트 구현, Nodejs 백엔드 구현<br /><br>
              현재 수정, 업데이트 진행중
            </p>
            <div class="buttons">
              <MaterialButton color="white" class="mt-4"
                >Open Link</MaterialButton
              >
              <MaterialButton color="white" class="mt-4 m-3"
                >Git Code</MaterialButton
              >
            </div>
          </div>
        </div>
